...
- `.github/.templates/`: source templates that define the structure for TODO and context files; never store project data here.
...
- Regenerate TODO or context files from `.github/.templates/` when structure drifts.
